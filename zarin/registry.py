...
_M = [
    ...
    Metric("first_try_conv", "نرخ موفقیت در اولین تلاش", "سهم جلسه‌هایی که همان تلاش اول آن‌ها موفق (Verified/Paid) بوده است.",
           "first_try_ok ÷ sessions", "session"),
    ...
    Metric("recovery_rate", "نرخ بازیابی پس از شکست اول", "از جلسه‌هایی که تلاش اولشان ناموفق بود، چه سهمی در نهایت موفق شدند.",
           "recovered ÷ (sessions with attempted and first try not ok)", "session"),
