...
## کارایی (اندازه‌گیری‌شدهٔ واقعی)

- ساخت marts از CSV خام (یک‌بار): **۳۲٫۶ ثانیه** (اندازه‌گیری‌شده). اجرای گرمِ بعدی فوری.
- تأخیر گرمِ API روی **بزرگ‌ترین پذیرنده M250 (۱٫۰۵ میلیون جلسه)** — همه زیر یک ثانیه:
  overview ‏0.30s · funnel ‏0.38s · peers ‏0.25s · changes ‏0.23s · insights ‏0.51s ·
  customers ‏0.70s (سنگین‌ترین: اسکن کوهورت/فاصلهٔ خرید روی کل تاریخچه).
- برای پذیرندهٔ کوچک‌تر (M156): overview ‏0.27s · insights ‏0.34s.
